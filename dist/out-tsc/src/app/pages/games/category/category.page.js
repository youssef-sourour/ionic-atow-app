...
var CategoryPage = /** @class */ (function () {
    function CategoryPage(twirlAndTipService, authService, navCtrl, storage, theme, platform, splashScreen, statusBar, database, element, alertCtrl, alertService, loading, route) {
    ...
    CategoryPage.prototype.initializeApp = function () {
        var _this = this;
    ...
    CategoryPage.prototype.twirlAndTipModel = function () {
    ...
    CategoryPage.prototype.togglePopupMenu = function () {
        return this.openMenu = !this.openMenu;
    };
    CategoryPage.prototype.playWithTheme = function (theme) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
    ...
    CategoryPage.prototype.createSaveGameData = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var date;
            return tslib_1.__generator(this, function (_a) {
    ...
    CategoryPage.prototype.updateSaveGameData = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                this.saveGameData.score = this.score;
                this.saveGameData.wordGridResult = this.wordGridResult;
    ...
    CategoryPage.prototype.deleteSaveGameData = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
    ...
    CategoryPage.prototype.getWordLibDBArr = function (numGameLetter, firstLastLetter, category, theme) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.database.getWordLibByCategory(numGameLetter, firstLastLetter, category).subscribe(function (data) {
                // get Lib data
    ...
    CategoryPage.prototype.alertNoWord = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var alertNoWord;
            var _this = this;
            return tslib_1.__generator(this, function (_a) {
    ...
    CategoryPage.prototype.alertEndGame = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib_1.__generator(this, function (_a) {
    ...
    // alert when complete game
    CategoryPage.prototype.alertEndGameUnlockNewGame = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib_1.__generator(this, function (_a) {
    ...
    CategoryPage.prototype.getScoreLibArr = function () {
        var _this = this;
        return new Promise(function (resolve, reject) {
    ...
    CategoryPage.prototype.defineGridResultArr = function () {
        for (var i = 0; i < this.numGameWord; i++) {
    ...
    CategoryPage.prototype.selectGameData = function (form) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                this.getWordLibDBArr(this.numGameLetter, this.firstLastLetter, this.category, 'spring').then(function (data) {
                    console.log(data);
                }, function (error) {
                });
    ...
    CategoryPage.prototype.checkResultOfRow = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var x, j, j;
            var _this = this;
            return tslib_1.__generator(this, function (_a) {
                ...
                if (this.checkWordInLib(this.wordResult)) {
                    ...
                    if (this.focusJ === this.numGameLetter - 1) {
                        ...
                        this.getWordLibDBArr(this.numGameLetter, this.finalLetterOfRow, this.category, -1).then(function (data) {
                            console.log(data);
                        }, function (error) {
                        });
                        this.setLetter();
    ...
    CategoryPage.prototype.checkWordInLib = function (wordNeedCheck) {
    ...
    CategoryPage.prototype.calcScore = function (wordNeedCalc) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var x, lenx, y, leny;
            return tslib_1.__generator(this, function (_a) {
    ...
    CategoryPage.prototype.selectLetter = function (letterSelected) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
    ...
    CategoryPage.prototype.setLetter = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
    ...
    CategoryPage.prototype.chooseHint = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var chooseHint;
            var _this = this;
            return tslib_1.__generator(this, function (_a) {
    ...
    CategoryPage.prototype.disableKey = function (keyCode) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
    ...
    CategoryPage.prototype.resetKey = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var x, keyCode;
            return tslib_1.__generator(this, function (_a) {
                for (x = 97; x <= 122; x++) {
    ...
    //Function when click hint
    CategoryPage.prototype.useHint = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
    ...
    CategoryPage.prototype.setLetterToLabel = function (letterSelected) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var label;
            return tslib_1.__generator(this, function (_a) {
    ...
    CategoryPage.prototype.displayKeyboard = function () {
    ...
    // set focus to cij
    CategoryPage.prototype.setFocus = function (i, j) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                console.log('i j:' + i + j);
                this.focusI = i;
    ...
    // Display Keyboard
    CategoryPage.prototype.toogleOpenKeyboard = function () {
        return this.openKeyboard = true;
    };
    CategoryPage.prototype.onSelectCate = function (category) {
