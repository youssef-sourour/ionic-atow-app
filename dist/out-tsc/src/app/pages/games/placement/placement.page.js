...
var PlacementPage = /** @class */ (function () {
    function PlacementPage(twirlAndTipService, authService, navCtrl, storage, theme, platform, splashScreen, statusBar, database, element, alertCtrl, alertService, loading, route) {
    ...
    PlacementPage.prototype.ionViewWillEnter = function () {
        var _this = this;
    ...
    PlacementPage.prototype.ionViewDidEnter = function () {
    ...
    PlacementPage.prototype.initializeApp = function () {
        var _this = this;
    ...
    PlacementPage.prototype.ngOnInit = function () {
    };
    PlacementPage.prototype.twirlAndTipModel = function () {
    ...
    PlacementPage.prototype.togglePopupMenu = function () {
        return this.openMenu = !this.openMenu;
    };
    PlacementPage.prototype.playWithTheme = function (theme) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
    ...
    PlacementPage.prototype.createSaveGameData = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var date;
            return tslib_1.__generator(this, function (_a) {
    ...
    PlacementPage.prototype.updateSaveGameData = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                this.saveGameData.score = this.score;
                this.saveGameData.wordGridResult = this.wordGridResult;
    ...
    PlacementPage.prototype.deleteSaveGameData = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
    ...
    PlacementPage.prototype.getWordLibDBArr = function (numGameLetter, firstLastLetter, theme) {
        var _this = this;
    ...
    PlacementPage.prototype.alertNoWord = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var alertNoWord;
            var _this = this;
            return tslib_1.__generator(this, function (_a) {
    ...
    PlacementPage.prototype.alertEndGame = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib_1.__generator(this, function (_a) {
    ...
    // alert when complete game
    PlacementPage.prototype.alertEndGameUnlockNewGame = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib_1.__generator(this, function (_a) {
    ...
    PlacementPage.prototype.getScoreLibArr = function () {
        var _this = this;
        return new Promise(function (resolve, reject) {
    ...
    PlacementPage.prototype.defineGridResultArr = function () {
        for (var i = 0; i < this.numGameWord; i++) {
    ...
    PlacementPage.prototype.checkResultOfRow = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var x, j, j;
            var _this = this;
            return tslib_1.__generator(this, function (_a) {
    ...
    PlacementPage.prototype.checkWordInLib = function (wordNeedCheck) {
    ...
    PlacementPage.prototype.calcScore = function (wordNeedCalc) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var x, lenx, y, leny;
            return tslib_1.__generator(this, function (_a) {
    ...
    PlacementPage.prototype.selectLetter = function (letterSelected) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
    ...
    PlacementPage.prototype.setLetter = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
    ...
    PlacementPage.prototype.chooseHint = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var chooseHint;
            var _this = this;
            return tslib_1.__generator(this, function (_a) {
    ...
    PlacementPage.prototype.disableKey = function (keyCode) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
    ...
    PlacementPage.prototype.resetKey = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var x, keyCode;
            return tslib_1.__generator(this, function (_a) {
                for (x = 97; x <= 122; x++) {
    ...
    //Function when click hint
    PlacementPage.prototype.useHint = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
    ...
    PlacementPage.prototype.setLetterToLabel = function (letterSelected) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var label;
            return tslib_1.__generator(this, function (_a) {
    ...
    PlacementPage.prototype.displayKeyboard = function () {
    ...
    // set focus to cij
    PlacementPage.prototype.setFocus = function (i, j) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                console.log('i j:' + i + j);
                this.focusI = i;
    ...
    // Display Keyboard
    PlacementPage.prototype.toogleOpenKeyboard = function () {
        return this.openKeyboard = true;
    };
    PlacementPage = tslib_1.__decorate([
        Component({
...
//# sourceMappingURL=placement.page.js.map